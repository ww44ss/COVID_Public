...
daily_deaths_per_capita <- ggplot(data = d_p, aes(x = date) ) + 
 ...
 geom_col(aes(y = 100000.*daily_deaths2/us_pop), color = "grey80", width = 0.7, alpha = 0.5)+
  ...
  labs(title = "Daily US Deaths per 100k Population", subtitle = str_c("US trend is ", daily_deaths_per_100k_trend, " deaths per day"), y = "deaths per 100k per day")+ 
...
daily_deaths <- ggplot(data = d_p, aes(x = date) ) + 
 ...
 geom_col(aes(y = daily_deaths2), color = "grey80", width = 0.7, alpha = 0.5)+
  ...
  labs(title = "Daily US Deaths ", subtitle = str_c("US trend is ", round(daily_deaths_per_100k_trend, 2), " deaths per day per 100k"), y = "deaths per day")+ 
