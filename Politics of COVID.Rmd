...
ggplot(data = data_x, aes(x = party_sku, y = 100000*(daily_cases+.1)/population, color = party_sku))+
scale_color_gradient(low = "blue", high = "red") + 
  geom_point(size = 0.3, alpha = 0.2) + scale_y_log10() + 
  geom_smooth() + labs(title = "Vote Skew 2016 Election", subtitle = "County Level Voter and COVID data", y = "daily cases per 100k population", x = "Vote toward Trump")
