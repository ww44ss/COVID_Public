 ...
 state_abb <- bind_cols(state = state.name, ST = state.abb)
  ...
  ggplot(crs = st_crs(102003)) + 
    ...
    theme(axis.title.x=element_blank(),
          ...
          panel.grid.minor = element_blank(),
          strip.text = element_text(color = "#154555", size = 12, face = "bold")) +
    labs(title = str_c('TOTAL CASES PER CAPITA COVID-19: data through ', date_display),
         subtitle=str_c("NYTimes COVID19 Database"), "color = cases/100k") +
     annotate(geom="text", x=-70,
             y=25,
             label=str_c("ww44ss - ", today() ), size = 2.5,
 ...
 state_abb <- bind_cols(state = state.name, ST = state.abb)
  ...
  ggplot(crs = st_crs(102003)) + 
    ...
    theme(axis.title.x=element_blank(),
          ...
          panel.grid.minor = element_blank(),
          strip.text = element_text(color = "#154555", size = 12, face = "bold")) +
    labs(title = str_c('DAILY CASES PER CAPITA COVID-19: data through ', date_display),
         subtitle=str_c("NYTimes COVID19 Database"), "color = cases/100k") +
     annotate(geom="text", x=-70,
             y=25,
             label=str_c("ww44ss - ", today() ), size = 2.5,
 ...
 state_abb <- bind_cols(state = state.name, ST = state.abb)
  ...
  counties <- counties_max %>%
    ...
    theme(axis.title.x=element_blank(),
          ...
          panel.grid.minor = element_blank(),
          strip.text = element_text(color = "#154555", size = 12, face = "bold")) +
    labs(title = str_c('TOTAL MORTAILITY PER CAPITA COVID-19: data through ', date_display),
         subtitle=str_c("NYTimes COVID19 Database"), "color = cases/100k") +
     annotate(geom="text", x=-70,
             y=25,
             label=str_c("ww44ss - ", today() ), size = 2.5,
