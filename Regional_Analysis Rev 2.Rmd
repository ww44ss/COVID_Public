...
states <- states_cache
  ...
  plot_colors <- brewer.pal(n = 11, name = "OrRd")
  plot_colors_deaths <- brewer.pal(n = 11, name = "Reds")
...
t_cases_per_capita <-    
  ggplot() + 
    ...
    coord_sf(xlim = c(as.numeric(bbox[1]), as.numeric(bbox[3])), ylim = c(as.numeric(bbox[2]), as.numeric(bbox[4])), expand = FALSE) +
    scale_fill_gradientn(colors =plot_colors, name = TeX("Cases/100k"), limits = c(0, 10000), na.value = "red") + 
    theme_bw()+
    theme(axis.title.x=element_blank(),
          axis.text.x=element_blank(),
          axis.ticks.x=element_blank(),
...
t_deaths <-    
  ggplot() + 
    ...
    coord_sf(xlim = c(as.numeric(bbox[1]), as.numeric(bbox[3])), ylim = c(as.numeric(bbox[2]), as.numeric(bbox[4])), expand = FALSE) +
    scale_fill_gradientn(colors =plot_colors_deaths, name = TeX("Deaths"), limits = c(0, 30000), na.value = "red") + 
    theme_bw()+
    theme(axis.title.x=element_blank(),
          axis.text.x=element_blank(),
          axis.ticks.x=element_blank(),
...
t_deaths_per_capita <-    
  ggplot() + 
    ...
    coord_sf(xlim = c(as.numeric(bbox[1]), as.numeric(bbox[3])), ylim = c(as.numeric(bbox[2]), as.numeric(bbox[4])), expand = FALSE) +
    scale_fill_gradientn(colors =plot_colors_deaths, name = TeX("Deaths/100k"), limits = c(0, 200), na.value = "red") + 
    theme_bw()+
    theme(axis.title.x=element_blank(),
          axis.text.x=element_blank(),
          axis.ticks.x=element_blank(),
...
```{r, warning = F, message = F, error = F, fig.align='center', fig.height =4.5, fig.width = 8, echo = F, eval = T}
...
## per capita cases
 ...
 state_abb <- bind_cols(state = state.name, ST = state.abb)
  ...
  plot_colors <- c("grey99","rosybrown1", "rosybrown4")
...
## per capita deaths
 ...
 state_abb <- bind_cols(state = state.name, ST = state.abb)
  ...
  #plot_colors <- rev(c(brewer.pal(n = 5, name = "RdYlGn"), "#3392B2"))
  plot_colors <- c("grey99","violetred1", "violetred4")
