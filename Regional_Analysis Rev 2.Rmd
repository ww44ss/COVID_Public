...
grid.arrange(p_total_cases, daily_cases_per_capita, p_total_deaths, daily_deaths_per_capita,  nrow = 2)
...
## per capita cases
 ...
 state_abb <- bind_cols(state = state.name, ST = state.abb)
  ...
  data_max <- final_plot_data %>%
    ...
    mutate(per_capita = ifelse(per_capita > 5000, 5000, per_capita)) %>%
...
state_list = c("WA", "OR", "CA", "ID", "NV", "AZ")
...
```{r, warning=F, error=F, fig.align='center', message = F, error=F, warning = F, fig.height=4, fig.width = 9}
